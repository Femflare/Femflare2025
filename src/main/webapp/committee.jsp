...
<%@include file="mainnavbar.jsp" %>
    <div class="container">
        <h1>Co-Conveners & Organizing Committee</h1>
        <table>
            <thead>
                <tr>
                    <th>S. No.</th>
            ...
            <tbody>
                <%
                    String[][] committeeData = {
                        ...
                        {"8", "Hospitality & Guests", "Dr. I. Govardhini, Dr. A. Pavani, Dr. Ch. Neelima, Dr. Raju Anitha, Mrs. N. Bhargavi, Ms. S. Vijaya Lakshmi"},
                        ...
                        {"16", "Events (Literary, Spot Technical and Non-Technical etc.)", "Dr. S. Lavanya, Assoc. Prof, English., Dr. K. Sireesha, Asst. Prof, MDI&E., Dr. Vyoma Singh, Assoc. Prof, ECE., Mr. P. Srikanth Reddy, Asst. Prof -(ECE)., Dr. P. Rajeswari, Assoc. Prof, Pharmacy."},
